            ...
            <div className="container mt-5 mb-5  c1" style={divmar}>
                ...
                <div className="resume-grid">
						<div className="s1">
							...
							<br/>
								<h5 > <span style={bc}> Center for Advanced Research in Engineering(CARE) </span>  Frontend Engineer</h5>
								<p>
									Aug 2019 – Current, Islamabad
								</p>
							<ul>
                                <li>Worked with Design Engineers on Wireframing of ERP Solution for PAC Kamra. </li>
								...
								<h5 > <span  style={bc} > EYCON Pvt Limited </span>  Web Developer | Intern</h5>
								<p>
									March 2019 – May 2019, Islamabad
								</p>
								...
								<h5 > <span  style={bc}> Bright Spyre </span>  UI Developer | Intern</h5>
								<p>
									Sept 2014 – Nov 2015, Mumbai
								</p>
                                <ul>
                                <li>Worked with Design Engineers on Wireframing of ERP Solution for PAC Kamra. </li>
                                <li>Parse JSON to HTML Dynamically</li>
